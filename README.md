...
The prefered way to run this is via Docker. Just use the included [https://git.sr.ht/~psic4t/atomstr/blob/master/docker-compose.yaml](docker-compose.yaml) and modify it to your needs. It contains ready to run Traefik labels. You can remove this part, if you are using ngnix or HAproxy.
